  ...
  const handleAddItem = async (e) => {
    ...
    try {
      if (currentItem) {
        ...
        await axios.put(`${import.meta.env.VITE_API_URL}/items/${currentItem._id}`, { name, description }, {
          headers: {
        ...
        // Add new item
        await axios.post(`${import.meta.env.VITE_API_URL}/items`, { name, description }, {
          headers: {
            'Authorization': `Bearer ${token}`
          }
        });
